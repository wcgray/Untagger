...
func defaulTagAction(tagName : String, document : UntaggerDocument) -> TagAction? {
    var tagAction : TagAction? = nil
    
    let isIgnorable = ["style","script","option","object","embed","applet","link","noscript"].contains(tagName.lowercased())
    let isInlineNoWhitespace = ["font","acronym","abbr","var","sub","tt","code","sup","span","strong","em","i","b","u","strike"].contains(tagName.lowercased())
